...
public final class ActivityFoundWritingBinding implements ViewBinding {
  ...
  private ActivityFoundWritingBinding(@NonNull RelativeLayout rootView,
      @NonNull LinearLayout RegLay, @NonNull Button addMapBtnFound,
      @NonNull Button addPhotoBtnFound, @NonNull EditText contentTextEditFound,
      @NonNull ProgressBar foundWritingProg, @NonNull ProgressBar progressBar,
      @NonNull TextView regShow, @NonNull Button submitBtnFound, @NonNull EditText titleEditFound,
  ...
  public static ActivityFoundWritingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFoundWritingBinding((RelativeLayout) rootView, RegLay, addMapBtnFound,
          addPhotoBtnFound, contentTextEditFound, foundWritingProg, progressBar, regShow,
          submitBtnFound, titleEditFound, userUploadImageFound);
    }
