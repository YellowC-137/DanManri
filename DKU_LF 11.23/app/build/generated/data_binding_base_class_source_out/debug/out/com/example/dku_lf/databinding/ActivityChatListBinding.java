...
public final class ActivityChatListBinding implements ViewBinding {
  ...
  private ActivityChatListBinding(@NonNull ConstraintLayout rootView, @NonNull ListView chatList,
      @NonNull TextView chatListMain) {
  ...
  public static ActivityChatListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.chat_list;
      ListView chatList = rootView.findViewById(id);
      if (chatList == null) {
        break missingId;
      }
