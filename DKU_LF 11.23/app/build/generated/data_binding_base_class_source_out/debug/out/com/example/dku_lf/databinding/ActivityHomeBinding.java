...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  private ActivityHomeBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout Homecontainer, @NonNull BottomNavigationView navView) {
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout Homecontainer = (ConstraintLayout) rootView;
      ...
      return new ActivityHomeBinding((ConstraintLayout) rootView, Homecontainer, navView);
    }
